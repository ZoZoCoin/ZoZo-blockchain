...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | CTxIn | The unspent output which is holding 1000 ZZC
| # | addr | CService | Address of the main 1000 ZZC unspent output
| 33-65 | pubKeyCollateralAddress | CPubKey | CPubKey of the main 1000 ZZC unspent output
