...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Zozocoin Core zozocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  zozocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zozocoin transaction") + "\n" +
              "  zozocoin-tx [options] -create [commands]   " + _("Create hex-encoded zozocoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zozocoin transaction
