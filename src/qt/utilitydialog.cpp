    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Dtmi Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Dtmi Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  dtmi-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Dtmi in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 DTMI, 0.1 DTMI, 1 DTMI and 10 DTMI -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://dtmipay.atlassian.net/wiki/display/DOC/PrivateSend\">https://dtmipay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Dtmi Core is shutting down...") + "<br /><br />" +
