    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Zozo Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #F8F8F8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #00af25, stop: 1 #34af25); border-radius: 7px; margin: 0px; }");
    }
    else
    {
        progressBar->setStyleSheet("QProgressBar { height: 2px !important; background-color: #F8F8F8; border: 1px solid grey; border-radius: 2px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #00af25, stop: 1 #34af25); }");
    }
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zozocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zozocoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Zozocoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Zozocoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zozocoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zozocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zozocoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a zozocoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zozocoin Core help message to get a list with possible Zozocoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Zozocoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zozocoin network", "", count));
}
...
{
    QString strTitle = tr("Zozocoin Core"); // default title
