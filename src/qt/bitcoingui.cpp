    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Dtmi Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dtmi address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dtmi: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Dtmi Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dtmi Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dtmi Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dtmi addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dtmi addresses"));
    ...
    openAction->setStatusTip(tr("Open a dtmi: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dtmi Core help message to get a list with possible Dtmi Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Dtmi Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dtmi network", "", count));
}
...
{
    QString strTitle = tr("Dtmi Core"); // default title
