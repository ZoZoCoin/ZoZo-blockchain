...
{
public:
    /// Is the input associated with this public key? (and there is 1000 ZOZO - checking if valid masternode)
...
private:
    ...
    /// Get the denominations for a specific amount of zozocoin.
