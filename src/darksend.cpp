...
{
    if(fLiteMode) return; // ignore all Zozocoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Zozocoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("zozocoin-privatesend");
