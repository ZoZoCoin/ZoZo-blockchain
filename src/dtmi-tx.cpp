...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Dtmi Core dtmi-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dtmi-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dtmi transaction") + "\n" +
              "  dtmi-tx [options] -create [commands]   " + _("Create hex-encoded dtmi transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dtmi transaction
