 ...
 *
 *   // network
 *   CDtmiNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.dtmi.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CDtmiNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: DtmiNetwork
// //   -- signature requirements : Key1(User)
// class CDtmiNetworkVariable : public CGovernanceObject
// {
// private:
