...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ZozocoinNetwork") type = ZozocoinNetwork;
    if(strType == "ZozocoinNetworkVariable") type = ZozocoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ZozocoinNetwork) s = "ZozocoinNetwork";
    if(type == ZozocoinNetworkVariable) s = "ZozocoinNetworkVariable";
