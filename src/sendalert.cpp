...
2. run zozocoind with -printalert or -sendalert like this:
   /path/to/zozocoind -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.zozocoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Zozocoin Core:0.12.0.58/"));
