...
2. run dtmid with -printalert or -sendalert like this:
   /path/to/dtmid -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.dtmi.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Dtmi Core:0.12.0.58/"));
