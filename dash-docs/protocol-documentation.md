...
This document describes the protocol extensions for all additional functionality build into the Dtmi protocol. This doesn't include any of the Bitcoin procotol, which has been left in tact in the Dtmi project. For more information about the core protocol, please see https://en.bitcoin.it/w/index.php?title#Protocol_documentation&action#edit
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | CTxIn | The unspent output which is holding 1000 DTMI
| # | addr | CService | Address of the main 1000 DTMI unspent output
| 33-65 | pubKeyCollateralAddress | CPubKey | CPubKey of the main 1000 DTMI unspent output
