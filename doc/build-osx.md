...
dashd/dash-cli binaries are not included in the Zozo-Qt.app bundle.

If you are building `dashd` or `Zozo Core` for others, your build machine should be set up
