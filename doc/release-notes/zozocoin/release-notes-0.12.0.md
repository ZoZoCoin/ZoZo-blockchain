...
Zozocoin Core version 0.12.0 is now available from:

  https://zozocoinpay.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/zozocoinpay/zozocoin/issues
...
backwards-compatible with pre-0.12 versions of Zozocoin Core or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/zozocoin/).
