...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ ZZC, _12_ times over the course of a year totaling _24000_ ZZC.
...
When block ```1000000``` is reached you'll receive a payment for ```1200``` ZZC to ```y6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7```.
