...
Dtmi Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 2227.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 13772 for connections and services them.
...
However, in open source software such as Dtmi Core, where everyone uses
...
pay attention to for reviewers of Dtmi Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Dtmi Core uses tinyformat, which is type safe. Leave them out to avoid confusion
