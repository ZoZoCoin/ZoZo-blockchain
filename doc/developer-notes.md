...
Zozocoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Zozocoin Core, where everyone uses
...
pay attention to for reviewers of Zozocoin Core code.

General Zozocoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Zozocoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
