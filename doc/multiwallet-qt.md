...
Only requiring some minor changes is zozocoin.cpp.
...
Changes to zozocoin.cpp
----------------------
zozocoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
